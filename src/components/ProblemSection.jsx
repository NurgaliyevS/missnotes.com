...
export var ProblemSection = function () {
    var painPoints = [
        {
            icon: Clock,
    ...
    return (<section className="py-24 bg-gradient-subtle relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {painPoints.map(function (point, index) { return (<div key={index} className="group relative animate-fade-up hover:scale-105 transition-all duration-300" style={{ animationDelay: "".concat(index * 150, "ms") }}>
