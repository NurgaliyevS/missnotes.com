    ...
    return (<section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6 max-w-2xl mx-auto">
          {plans.map(function (plan, index) { return (<div key={index} className={"max-w-xs relative bg-card p-8 rounded-2xl shadow-soft border animate-fade-up hover:shadow-medium transition-all duration-300 ".concat(plan.popular
                ? "border-primary shadow-glow scale-105"
                : "border-secondary shadow-soft")} style={{ animationDelay: "".concat(index * 100, "ms") }}>
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map(function (feature, featureIndex) { return (<li key={featureIndex} className="flex items-center gap-3">
