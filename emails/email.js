...
function getDay1mail(userName = "") {
  return {
    ...
    html: `
      ...
      <p style="font-size:14px;line-height:24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;margin-top:16px;margin-bottom:16px">Every meeting feels like a nightmare?</p>
...
export { getDay1mail, sendDay1Email, setupEmail, getDay2Email, sendDay2Email, getDay3Email, sendDay3Email, getDay4Email, sendDay4Email };
